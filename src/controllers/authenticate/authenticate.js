...
const { validateBodyAuthenticate, validateExistentSocialAccount } = require('./case')
...
exports.method = 'POST'
exports.middleware = [validateBodyAuthenticate, validateExistentSocialAccount, validateErrorBody]
